			...
			<div class="row">
				<div class="card w-50">
					<div class="card-header">
						<h4>Insert details of the restaurant</h4>
					</div>
					<div class="card-body">
						<form class="" method="post" enctype="multipart/form-data">
									...
									<div class="form-group">
										<label>Number of chef :</label>
										<input type="text" name="nchef" class="form-control">
									</div>
									<div class="form-group">
										<label>Number of employee :</label>
										<input type="text" name="nemployee" class="form-control">
									</div>
