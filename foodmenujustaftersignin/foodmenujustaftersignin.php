<?php
	...
	$info=$blog->viewprofile($name,$pass);*/
	$id=$_GET['id'];
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="my-nav">
					<ul class="navbar-nav ml-auto">
						...
						<li><a href="../foodmenuaftersignin/foodmenuaftersignin.php?id=<?php echo $id ?>" class="nav-link active" style="font-size: 20px;">Food Menu</a></li>
						...
						<li class="dropdown">
							...
							<div class="dropdown-menu bg-grey">
								<a href="../aboutchefs/aboutchefs.php?id=<?php echo $id ?>" class="dropdown-item">About Restaurant</a>
								<a href="../aboutchefs/aboutchefs.php?id=<?php echo $id ?>" class="dropdown-item">About Chef</a>
								<a href="../aboutchefs/aboutchefs.php?id=<?php echo $id ?>" class="dropdown-item">About Employee</a>
								<a href="../aboutchefs/aboutchefs.php?id=<?php echo $id ?>" class="dropdown-item">About Food-Item</a>
							</div>
							
						</li>
						<li><a href="../profile/profile.php?id=<?php echo $id ?>" class="nav-link" style="font-size: 20px;">My Profile</a></li>
			...
			<div class="row">
				<div class="col-lg-12">
					...
					<div class="card float-left m-3" style="width: 300px;height: 400px;">
						...
						<div class="card-body">
							<div >
								<img src="<?php echo $blogs['image'] ?>" class="" height="190px" width="100%">
							</div>
							<div>
						...
						<div class="card-footer">
							...
							<a href="../cartresults/cartresults.php?id=<?php echo (($id*10000)+$blogs['id']) ?>"><button type="button" class="float-right">Add To Cart</button></a>
						</div>
					</div>
					<?php } ?>
				</div>
